...
namespace CodeMonkey.Utils {
    ...
    public static class UtilsClass {
        ...
        public static Vector3 GetMouseWorldPosition(float CameraDistanceTargetPlane) {
            Vector3 vec = GetMouseWorldPositionWithZ(new Vector3(Input.mousePosition.x,Input.mousePosition.y,CameraDistanceTargetPlane), Camera.main);
            vec.z = 0f;
            return vec;
        }
        ...
        public static bool GetMouseWorldPositionWithRay(out Vector3 worldPos )
        {
            var ray = Camera.main.ScreenPointToRay(Input.mousePosition);
            RaycastHit InfoHit;
            if (Physics.Raycast(ray,out InfoHit,Camera.main.farClipPlane))
            {
                worldPos = InfoHit.point;
                return true;
            }
